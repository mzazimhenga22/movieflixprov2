...
exports.makeTMDBRequest = makeTMDBRequest;
exports.getMovieMediaDetails = getMovieMediaDetails;
exports.getShowMediaDetails = getShowMediaDetails;
...
async function makeTMDBRequest(url, appendToResponse) {
    ...
    const key = (0, config_1.getConfig)().tmdbApiKey;
