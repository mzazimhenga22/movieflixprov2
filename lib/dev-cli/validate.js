...
const __1 = require("..");
async function processOptions(sources, options) {
    ...
    if (options.fetcher === 'native') {
        fetcher = (0, __1.makeStandardFetcher)(fetch);
    }
    else {
        fetcher = (0, __1.makeStandardFetcher)(node_fetch_1.default);
    }
    const providerOptions = {
        fetcher,
        target: __1.targets.ANY,
