...
class Blowfish {
    ...
    iv;
    constructor(t) {
        this.sBox0 = constants_1.sBox0.slice();
        this.sBox1 = constants_1.sBox1.slice();
        this.sBox2 = constants_1.sBox2.slice();
        this.sBox3 = constants_1.sBox3.slice();
        this.pArray = constants_1.pArray.slice();
