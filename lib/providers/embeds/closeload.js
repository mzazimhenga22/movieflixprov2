...
exports.closeLoadScraper = void 0;
...
exports.closeLoadScraper = (0, base_1.makeEmbed)({
    id: 'closeload',
    name: 'CloseLoad',
    rank: 106,
    async scrape(ctx) {
        ...
        const decoded = (0, unpacker_1.unpack)(evalCode);
        ...
        if (base64EncodedUrl.startsWith('http://') || base64EncodedUrl.startsWith('https://')) {
            ...
            if (!isValidBase64) {
                throw new errors_1.NotFoundError('Invalid base64 encoding found in source url');
            }
            let decodedString;
            try {
                ...
                try {
                    ...
                    throw new errors_1.NotFoundError(`Failed to decode base64 source url: ${base64EncodedUrl.substring(0, 50)}...`);
                }
            }
            ...
            if (urlMatch) {
                ...
                throw new errors_1.NotFoundError(`Decoded string is not a valid URL: ${decodedString.substring(0, 100)}...`);
            }
        }
        return {
            stream: [
